...
<div class="container my-5 p-0">
  <div class="row text-center">
    <div class="col-6 border py-5">
      <a href="../img/sportswear.jpg" target="__blank"><img src="../img/sportswear.jpg" class="card-img-top" alt="REMERA NIKE GRAPHIC"></a>
    </div>
    <div class="col-4 m-auto py-3 border">
      <h2 class="py-3">Nike</h3>
        <p class=""> <strong> REMERA NIKE GRAPHIC</strong> </p>
        <p>Lucí un gran estilo urbano con la nueva Remera Nike Sportswear Graphic, está confeccionada en algodón para brindarte la suavidad y la comodidad que estabas buscando.</p>
        <p>Talles:  M - L - XL - XXL</p>
        <p class=""> Precio: <strong> $1800</strong> </p>
...
<div class="container ">
  <div class="row ">
      ...
      <div class="col-12 p-4 my-3 border" >
        <p class="autor border-bottom p-3" name="autor" ><strong>De:</strong> Diego </p>
        <p class="descripcion p-3 border" name="descripcion" >Me gustó mucho el producto, llego a tiempo. Confien y compren.</p>
        <p class="valoracion p-3" name="valoracion"> <strong>Valoración: </strong> 4/5</p>
        <p class="fecha font-weight-light p-3">10/05/2020</p>
      </div>
  </div>
</div>
